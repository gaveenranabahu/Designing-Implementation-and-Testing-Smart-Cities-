...
<div id="txt_66" style="position: absolute; left: 24px; top: 323px; width: 962px; height: 657px; overflow: hidden;">
  ...
  <img src="wpimages/wp0020b4c6_06.png" border="0" width="531" height="1" id="crv_20" alt="" onload="OnLoadPngFix()" style="position:absolute;left:24px;top:312px;">
  <div id="txt_66" style="position: absolute; left: 24px; top: 323px; width: 962px; height: 657px; overflow: hidden;">
       <h3 style="font-weight: normal;">Below is a representation of the incoming traffic in the past few days.The tabular format provides a clear overview of the outgoing traffic on each respective day, enabling easy comparison and analysis of the traffic patterns.</h3>
    ...
    if ($result->num_rows > 0) {
        echo '<table>';
        echo '<tr><th>Date</th><th>Place</th><th>Total Car Count Incoming</th><th>Total Truck Count Incoming</th><th>Total Bus Count Incoming</th></tr>';

        while ($row = $result->fetch_assoc()) {
            echo '<tr>';
            echo '<td>' . $row['date'] . '</td>';
            echo '<td>' . $row['place'] . '</td>';
            echo '<td>' . $row['total_car_count_incoming'] . '</td>';
            echo '<td>' . $row['total_truck_count_incoming'] . '</td>';
            echo '<td>' . $row['total_bus_count_incoming'] . '</td>';
            echo '</tr>';
        }
        echo '</table>';
    } else {
